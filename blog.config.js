...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.zsccy.top', // 网站地址
  ...
  FONT_AWESOME:
    ...
    'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://walinenotion.zsccy.top', // Waline 评论系统后端地址
