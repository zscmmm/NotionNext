...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '80cf7456e48e48ffa8788d94dba53766',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zsc', // 您的昵称 例如 zsc
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://no.zsccy.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xanxana211@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/zscmmm', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon2-48.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  CUSTOM_EXTERNAL_CSS: ['https://at.alicdn.com/t/c/font_4531781_71z9tojhqxe.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
  ...
  PRISM_THEME_LIGHT_PATH: '/prism-material-light.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-tomorrow.min.css', // 深色模式主题
  // 默认: solarizedlight.css
  // okaidia.css
  // // 感觉样式好少呀 
  // tomorrow.css //适合深色模式
  // twilight.css //适合量子黑
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'ZMRCVJT3H5', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || 'a585c97bbecb53c3645fec93cefc871c', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || 'e5304804df3fc904e36b7dc1574eeb25', // 客户端搜索用的KEY
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'ZJ4JoHuDOQWcbSyQIprf-',
  ...
  COMMENT_VALINE_PLACEHOLDER:
    ...
    COMMENT_WALINE_SERVER_URL: 'https://walinenotion.zsccy.top', // Waline 评论系统后端地址
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '66d80448c0dd1a4d0886d8358c75c94a', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-9VXXV1XHW3', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
